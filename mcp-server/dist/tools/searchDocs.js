        ...
        try {
            ...
            if (authError instanceof AuthError) {
                ...
                if (authError.deviceCodeInfo) {
                    ...
                    const authMessage = `I need authorization to search your knowledge base.\n\n` +
            ...
            throw new Error(`⚠️ Authentication error: ${authError.message}. Please try again.`);
        }
            ...
            if (error instanceof AuthError) {
                if (error.code === "unauthorized" && error.shouldRetry) {
                    ...
                    try {
                        ...
                        throw new Error(`Re-authentication failed: ${retryError.message}. Please try again.`);
                    }
                }
                else {
